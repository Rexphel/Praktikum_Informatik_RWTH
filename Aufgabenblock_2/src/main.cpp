...
void vAufgabe_4(void){
	...
	weg1.pushFahrzeug(std::make_unique<PKW>("Audi", randDouble(50, 350), &weg1, randDouble(4, 20),randDouble(30, 200)));
	weg1.pushFahrzeug(std::make_unique<Fahrrad>("MTB", randDouble(12,40), &weg1));
	weg1.pushFahrzeug(std::make_unique<PKW>("Mercedes", randDouble(50, 350), &weg1, randDouble(4, 20),randDouble(30, 200)));
...
void vAufgabe_5(void){
	...
	weg1->pushFahrzeug(std::make_unique<PKW>("Audi", randDouble(50, 350), std::make_unique<Fahren>(&weg1), randDouble(4, 20),randDouble(30, 200)));
	weg1->pushFahrzeug(std::make_unique<Fahrrad>("MTB", randDouble(12,40), std::make_unique<Fahren>(&weg1)));
	weg1->pushFahrzeug(std::make_unique<PKW>("Mercedes", randDouble(50, 350), std::make_unique<Fahren>(&weg1), randDouble(4, 20),randDouble(30, 200)));
